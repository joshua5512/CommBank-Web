...
// import { faSmile, faPlusCircle } from '@fortawesome/free-regular-svg-icons'
import EmojiPicker from '../../components/EmojiPicker' // Assuming you have a component like this
...
export function GoalManager(props: Props) {
  ...
  const onEmojiClick = (event, emojiObject) => {
    ...
    // You might want to dispatch an action to update the icon in your application state or backend
  }
